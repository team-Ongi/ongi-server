...
public class MedicationScheduleController {
    ...
    @Operation(summary = "복약 여부 체크", description = """
        ...
        """)
    @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "복약 여부 체크 완료", content = @Content(mediaType = "application/json",schema =@Schema(implementation = UpdateMedicationStatusResponse.class)))
